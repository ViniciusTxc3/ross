...
def _(mo):
    ...
    This example is based on Example 5.9.2 from {cite}`friswell2010dynamics`.


    Anisotropic Bearings. This system is the same as that of Example 5.9.1 except that the isotropic bearings are replaced by anisotropic bearings.
